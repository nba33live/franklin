...
function preload ()
{
    ...
    this.load.image('ship', 'assets/sprites/car.png');
...
function createParkingSpot() {
    ...
    var minX = 1200;
    var maxX = 1400;
    landscape.moveTo(minX, minY);
    landscape.lineTo(minX, minY);
    landscape.lineTo(maxX, minY);
    var x = maxX;
    var y =minY;
    var range = 20;
   do
   ...
   do
    ...
    landscape.strokePath();
    landscape.fillPath();
    landscape.moveTo(1600, minY);
    landscape.lineTo(1600, maxY);
    landscape.strokePath()
}
